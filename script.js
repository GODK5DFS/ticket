...
if (running) {
    ...
    /*
    แปลง RPM เป็นความเร็วแอนิเมชัน

    ยิ่ง RPM สูง
    เครื่องยนต์ยิ่งหมุนเร็ว
    */
    ...
    crank1.style.transform =
        `rotate(${angle}deg)`;

    crank2.style.transform =
    ...
    */
    ...
    rod1.style.transform =
        `rotate(${rodAngle1}deg)`;

    rod2.style.transform =
        `rotate(${rodAngle2}deg)`;


    /* =====================
       4 STROKE ENGINE

       เครื่องยนต์ครบหนึ่งรอบ
       ใช้ 720 องศา
    ===================== *